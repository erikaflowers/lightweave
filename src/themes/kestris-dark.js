// Kestris Dark Theme (default)
// The original dark theme — GitHub-inspired blue-gray tones

export default {
  id: 'kestris-dark',
  name: 'Kestris Dark',
  description: 'The original dark theme for Julian',
  group: 'kestris',
  colors: {
